                ...
                <div class="mt-6 sm:mt-8 lg:mt-0">
                    ...
                    <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                        ...
                        <a
                            href="#"
                            title=""
                            class="text-white mt-4 sm:mt-0 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none flex items-center justify-center"
                            role="button"
                        >
                            Buy now
                        </a>
        ...
        <div class="w-1/2 mx-auto py-6 sm:px-6 lg:px-8">
            ...
            <form action="{{ route('review.store', ['order_item_id' => $product['id']]) }}" method="POST">
                ...
                <div class="mt-6">
                    <button 
                        type="submit"
                        class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none flex items-center justify-center"
                    >
                        Submit Feedback
                    </button>
                </div>

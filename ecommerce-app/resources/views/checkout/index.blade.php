						...
						<table class="w-full text-left font-medium text-gray-900 dark:text-white md:table-fixed">
							<tbody class="divide-y divide-gray-200 dark:divide-gray-800">
								<tr>
									...
									<div class="flex items-center gap-4">
										<a href="#" class="flex items-center aspect-square w-10 h-10 shrink-0">
											<img class="w-10" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg" alt="imac image" />
										</a>
										</a>
								...
								<tr>
									...
									<div class="flex items-center gap-4">
										<a href="#" class="flex items-center aspect-square w-10 h-10 shrink-0">
											<img class="w-10" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/iphone-light.svg" alt="imac image" />
										</a>
										</a>
								...
								<tr>
									...
									<div class="flex items-center gap-4">
										<a href="#" class="flex items-center aspect-square w-10 h-10 shrink-0">
											<img class="w-10" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ipad-light.svg" alt="ipad image" />
										</a>
								...
								<tr>
									...
									<div class="flex items-center gap-4">
										<a href="#" class="flex items-center aspect-square w-10 h-10 shrink-0">
											<img class="w-10" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/xbox-light.svg" alt="xbox image" />
										</a>
								...
								<tr>
									...
									<div class="flex items-center gap-4">
										<a href="#" class="flex items-center aspect-square w-10 h-10 shrink-0">
											<img class="w-10" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/ps5-light.svg" alt="playstation image" />
										</a>
								...
								<tr>
									...
									<div class="flex items-center gap-4">
										<a href="#" class="flex items-center aspect-square w-10 h-10 shrink-0">
											<img class="w-10" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/macbook-pro-light.svg" alt="macbook image" />
										</a>
								...
								<tr>
									...
									<div class="flex items-center gap-4">
										<a href="#" class="flex items-center aspect-square w-10 h-10 shrink-0">
											<img class="w-10" src="https://flowbite.s3.amazonaws.com/blocks/e-commerce/apple-watch-light.svg" alt="watch image" />
										</a>
